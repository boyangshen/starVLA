#!/bin/bash
# run_vla_arena_train_qwen3_vl_2b_oft.sh
#
# Fine-tunes a Qwen3-VL-2B-OFT model on VLA-Arena training data (LeRobot format).
#
# Before running:
...
#   bash examples/VLA-Arena/train_files/run_vla_arena_train_qwen3_vl_2b_oft.sh
