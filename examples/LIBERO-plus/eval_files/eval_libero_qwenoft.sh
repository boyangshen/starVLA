...
export LIBERO_Python=/home/shenboyang/miniforge3/envs/libero_plus/bin/python
...
unnorm_key="libero"
your_ckpt=/memory/shenboyang/outputs/train/starvla/libero_qwen3_2boft/checkpoints/steps_100000_pytorch_model.pt
output_dir=/memory/shenboyang/outputs/train/starvla/libero_qwen3_2boft/eval_libero_plus
...
mkdir -p ${LOG_DIR}
mkdir -p ${output_dir}/libero_goal
mkdir -p ${output_dir}/libero_spatial
mkdir -p ${output_dir}/libero_object
mkdir -p ${output_dir}/libero_10
