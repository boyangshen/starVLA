...
your_ckpt=/memory/shenboyang/outputs/train/starvla/libero_spatial_loopoft_no_teacher_no_loop/checkpoints/steps_30000_pytorch_model.pt
...
echo "Log Path: ${log_path}/${folder_name}.log"
echo "=========================================="
