...
config_yaml=./examples/Robocasa_tabletop/train_files/loopoft_robocase.yaml
data_root_dir=/memory/shenboyang/myCache/starvla/robocase_dataset/PhysicalAI-Robotics-GR00T-X-Embodiment-Sim/
data_mix=fourier_gr1_unified_1000
run_root_dir=/memory/shenboyang/outputs/train/starvla
run_id=robocasa_loopoft
###########################################################################################
...
accelerate launch \
  ...
  # --trainer.pretrained_checkpoint /memory/shenboyang/outputs/train/starvla/robocasa_loopoft/checkpoints/steps_XXXXX_pytorch_model.pt \
